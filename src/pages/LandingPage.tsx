...
export function LandingPage() {
  ...
  const search = useCallback(async (q: string) => {
    ...
    try {
      ...
      // Deduplicate and rank: alias matches first, then name matches
        ...
        <div className="w-full max-w-lg relative">
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-12 pr-4 py-4 text-lg bg-white rounded-2xl shadow-md border border-gray-100 focus:outline-none focus:ring-2 focus:ring-amber-400 focus:border-transparent"
              autoComplete="off"
              spellCheck={false}
            />
          </div>
          ...
          {open && results.length > 0 && (
            <div
              ref={dropdownRef}
              className="absolute top-full mt-2 w-full bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden z-10"
            >
              {results.map((wl, i) => (
                <button
                  key={wl.id}
          ...
          {open && !searching && query.trim() && results.length === 0 && (
            <div ref={dropdownRef} className="absolute top-full mt-2 w-full bg-white rounded-2xl shadow-xl border border-gray-100 px-4 py-4 text-center text-gray-400 z-10">
